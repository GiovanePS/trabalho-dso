...
class TelaVacinacao:
    ...
    def pega_dados_vacinacao(self):
        layout = [
            [
                sg.Text("Data da vacinação (Exemplo: 31/12/1999):"),
                sg.InputText("", key="data_vacinacao"),
            ],
            [
                sg.Text("Código do animal vacinado:"),
                sg.InputText("", key="codigo_animal_vacinado"),
            ],
            [
                sg.Text("Código da vacina aplicada:"),
                sg.InputText("", key="codigo_vacina"),
            ],
            [sg.Push(), sg.Button("Confirmar"), sg.Cancel("Cancelar")],
        ]
    ...
    def mostra_vacinacao(self, dados_vacinacoes: list):
        ...
        for vacinacao in dados_vacinacoes:
            string_todas_vacinacoes += (
                f"Codigo da vacinação: {vacinacao['codigo_vacinacao']}\n"
            )
